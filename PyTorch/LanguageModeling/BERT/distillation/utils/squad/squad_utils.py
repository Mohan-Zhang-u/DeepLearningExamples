...
class SquadV1Processor(SquadProcessor):
    def __init__(self, aug_data=False):
        if not aug_data:
            self.train_file = "train-v1.1.json"
        else:
            self.train_file = "train-v1.1_aug.json"
        print("Using {} for training".format(self.train_file))
        self.dev_file = "dev-v1.1.json"
...
class SquadV2Processor(SquadProcessor):
    def __init__(self, aug_data=False):
        if not aug_data:
            ...
            self.train_file = "train-v2.0_aug.json"
